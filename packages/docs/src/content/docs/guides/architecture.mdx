---
title: Architecture
description: Understand how Zocdoc API Components components communicate
---

## Props Down, Events Up

All Zocdoc API Components components follow a strict unidirectional data flow:
...
```typescript
import type { ZdProviderSearchEvents, DetailOf } from '@zocdoc/api-components';
