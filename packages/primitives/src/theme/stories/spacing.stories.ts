  ...
  render: () => html`
    <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 24px;">
      <div>
        ...
        <div
          style="padding: var(--zd-spacing-sm); background: var(--zd-color-neutral-100); border: 1px dashed var(--zd-color-neutral-300);"
        >
      ...
      <div>
        ...
        <div
          style="padding: var(--zd-spacing-md); background: var(--zd-color-neutral-100); border: 1px dashed var(--zd-color-neutral-300);"
        >
          <div style="background: var(--zd-color-brand-100); padding: 8px;">Content</div>
        </div>
      </div>
      <div>
        ...
        <div
          style="padding: var(--zd-spacing-lg); background: var(--zd-color-neutral-100); border: 1px dashed var(--zd-color-neutral-300);"
        >
          <div style="background: var(--zd-color-brand-100); padding: 8px;">Content</div>
        </div>
      </div>
    ...
    <div style="display: flex; flex-direction: column; gap: 32px;">
      <div>
        ...
        <div style="display: flex; gap: var(--zd-spacing-xs);">
          <div
            style="width: 48px; height: 48px; background: var(--zd-color-brand-500); border-radius: 8px;"
          ></div>
          <div
            style="width: 48px; height: 48px; background: var(--zd-color-brand-500); border-radius: 8px;"
          ></div>
