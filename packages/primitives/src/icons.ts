...
export const zocdocIcons: Record<string, string> = {
  ...
  'info-circle': `<svg class="info" fill="currentColor" aria-hidden="true" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M6 1a5 5 0 1 0 0 10A5 5 0 0 0 6 1Zm0 2a.75.75 0 1 1 0 1.5.75.75 0 0 1 0-1.5ZM5.5 6a.5.5 0 0 1 1 0v2.1a.5.5 0 0 1-1 0V6Z"/></svg>`,
