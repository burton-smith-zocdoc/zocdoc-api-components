...
const { args, argTypes, template } = getStorybookHelpers<ZdAccordionItem>('zd-accordion-item', { excludeCategories: ['cssParts'] });
...
export const InAccordion: Story = {
  render: () => html`
    <zd-accordion>
      ...
      <zd-accordion-item heading="After your visit">Your summary appears in your account.</zd-accordion-item>
    </zd-accordion>
  `,
};
