...
export default css`
  ...
  button.control {
    ...
    /*
     * Charm keys the anchor's focus treatment off plain :focus, which it gets
     * away with because activating a link navigates away. A button keeps focus
     * after a click, so :focus would leave the highlight stuck on until you
     * click elsewhere.
     */
    &:focus-visible {
      outline: none;
